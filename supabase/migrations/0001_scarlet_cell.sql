/*
  ...
  1. New Tables
    - `sessions`
      ...
      - Includes token and expiry tracking
    - `entities`
      - Stores entity data and configurations
      - Includes name, description, and avatar
    - `web_apps`
      - Stores web application data
      - Links to sessions for ownership
